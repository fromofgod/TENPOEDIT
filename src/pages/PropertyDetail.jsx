...
const {
  ...
  FiShare2, FiCalendar, FiNavigation, FiHome, FiUsers, FiWifi, FiCar, FiShield,
  FiZap, FiDroplet, FiThermometer, FiCamera, FiMaximize2, FiInfo, FiTrendingUp,
  FiStar, FiEye, FiPrint, FiDownload, FiExternalLink, FiMap, FiX
} = FiIcons;
          ...
          {property.rent && (
            <div className="bg-gradient-to-r from-primary-50 to-blue-50 rounded-lg p-4 sm:p-6">
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                {property.deposit && (
                  <div>
                    <h3 className="text-sm font-medium text-gray-700 mb-1">敷金</h3>
                    ...
                    <div>
                      ...
                      <div className="grid grid-cols-1 gap-3 sm:gap-4">
                        ...
                        {property.details.securityDeposit && (
                          <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center p-3 bg-gray-50 rounded">
                            <span className="text-sm text-gray-600 font-medium">敷金</span>
                            <span className="text-sm sm:text-base text-gray-900 mt-1 sm:mt-0">{formatNumberOnly(property.details.securityDeposit)}万円</span>
                          </div>
                        )}
