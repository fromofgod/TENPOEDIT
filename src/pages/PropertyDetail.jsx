...
const {
  FiMapPin, FiSquare, FiClock, FiPhone, FiMail, FiChevronLeft, FiChevronRight,
  FiCalendar, FiNavigation, FiHome, FiUsers, FiWifi, FiCar, FiShield, FiZap,
  FiDroplet, FiThermometer, FiCamera, FiMaximize2, FiInfo, FiTrendingUp,
  FiStar, FiEye, FiPrint, FiDownload, FiExternalLink, FiMap, FiX, FiTrain,
  FiBuilding, FiDollarSign, FiKey, FiCalendarCheck, FiFileText
} = FiIcons;
...
const PropertyDetail = () => {
  ...
  const hasValue = (value) => {
    return value !== null && value !== undefined && value !== '' && value !== 0 && 
           value !== '無し' && value !== 'なし' && value !== 'NULL' && value !== 'null' && 
  ...
  const shareData = {
    ...
    text: `${property.title} - ${formatPrice(property.rent)}/月 ${property.address}`
  };
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="flex flex-col sm:flex-row sm:flex-wrap sm:items-center gap-2 sm:gap-4 text-gray-600">
                  ...
                  <div className="flex items-center space-x-1">
                    ...
                    <span className="text-xs sm:text-sm whitespace-nowrap">
                      更新: {new Date(property.lastUpdated).toLocaleDateString('ja-JP')}
                    </span>
                  </div>
                </div>
              </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-0">
                      ...
                      <div className="divide-y divide-gray-200">
                        ...
                        <div className="px-4 py-3 flex justify-between items-center bg-white hover:bg-gray-50">
                          ...
                          <span className="text-sm text-gray-900">
                            {property.details.usageArea ? `${formatArea(property.details.usageArea)}㎡` : 'ー'}
                          </span>
                        </div>
                        ...
                        <div className="px-4 py-3 flex justify-between items-center bg-white hover:bg-gray-50">
                          ...
                          <span className="text-sm text-gray-900 font-semibold">
                            {property.details.rentManYen ? formatManYen(property.details.rentManYen) : 'ー'}
                          </span>
                        </div>
                        ...
                        <div className="px-4 py-3 flex justify-between items-center bg-gray-50 hover:bg-gray-100">
                          ...
                          <span className="text-sm text-gray-900">
                            {property.details.managementFeeAmount ? formatManYen(property.details.managementFeeAmount) : 'ー'}
                          </span>
                        </div>
                        ...
                        <div className="px-4 py-3 flex justify-between items-center bg-white hover:bg-gray-50">
                          ...
                          <span className="text-sm text-gray-900">
                            {property.details.commonAreaFee ? formatManYen(property.details.commonAreaFee) : 'ー'}
                          </span>
                        </div>
                      ...
                      <div className="divide-y divide-gray-200 border-l border-gray-200">
                        ...
                        <div className="px-4 py-3 flex justify-between items-center bg-white hover:bg-gray-50">
                          ...
                          <span className="text-sm text-gray-900">
                            {property.details.renewalFeeAmount ? formatManYen(property.details.renewalFeeAmount) : 'ー'}
                          </span>
                        </div>
