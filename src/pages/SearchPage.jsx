...
const { FiFilter, FiGrid, FiList, FiChevronDown, FiMapPin, FiDatabase, FiLoader } = FiIcons;
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600">
            {loading ? 'データを読み込み中...' : `${filteredProperties.length}件の物件が見つかりました`}
          </p>
