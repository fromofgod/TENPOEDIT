      ...
      <div className="relative">
        ...
        {isNewProperty() && (
          <div className="absolute top-3 left-1/2 transform -translate-x-1/2">
            <span className="bg-green-500 text-white px-2 py-1 text-xs font-medium rounded animate-pulse">
              新着
            </span>
          </div>
        )}
      ...
      <div className="p-4">
        ...
        <div className="mt-4 pt-3 border-t border-gray-100 flex space-x-2">
          <Link
            ...
            className="quick-action-button flex-1 bg-primary-50 text-primary-600 py-2 px-3 rounded text-xs font-medium hover:bg-primary-100 transition-colors text-center"
            onClick={(e) => e.stopPropagation()}
          >
            詳細を見る
          </Link>
          <button
            className="quick-action-button flex-1 bg-gray-50 text-gray-600 py-2 px-3 rounded text-xs font-medium hover:bg-gray-100 transition-colors"
            onClick={(e) => e.stopPropagation()}
          >
            お問い合わせ
          </button>
        ...
        <div className="mt-2 text-center">
          <div className="flex items-center justify-center space-x-2 text-xs text-gray-500">
            <SafeIcon icon={FiCamera} className="text-xs" />
            <span>{property.images?.length || 1}枚</span>
            {isRealImage && (
              <>
                <span>•</span>
                <span className="text-blue-600 font-medium">実写画像</span>
              </>
            )}
          </div>
        </div>
