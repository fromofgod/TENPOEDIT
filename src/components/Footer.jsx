      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/list-property" className="text-gray-300 hover:text-white transition-colors">
                  物件掲載
                </Link>
              </li>
              <li>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 text-sm">
            <div>
              <h4 className="font-semibold text-green-400 mb-2">設立</h4>
              <p className="text-gray-300">{companyInfo.established}</p>
            </div>
            <div>
              <h4 className="font-semibold text-green-400 mb-2">資本金</h4>
              <p className="text-gray-300">{companyInfo.capital}</p>
            </div>
            <div>
              <h4 className="font-semibold text-green-400 mb-2">従業員数</h4>
              <p className="text-gray-300">{companyInfo.employees}</p>
            </div>
            {companyInfo.license && (
              <div>
                <h4 className="font-semibold text-green-400 mb-2">免許番号</h4>
                <p className="text-gray-300 text-xs">{companyInfo.license}</p>
              </div>
            )}
          </div>
          ...
          {companyInfo.president && (
            <div className="mt-6 pt-6 border-t border-gray-800">
              <h4 className="font-semibold text-green-400 mb-2">代表者</h4>
          ...
          <div className="mt-6 pt-6 border-t border-gray-800">
            <h4 className="font-semibold text-green-400 mb-2">事業内容</h4>
          ...
          {companyInfo.certifications && (
            <div className="mt-6 pt-6 border-t border-gray-800">
              <h4 className="font-semibold text-green-400 mb-2">許可・資格</h4>
