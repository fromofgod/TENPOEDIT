...
import { formatPrice, formatPriceWithCommas, formatDepositInfo, calculateTsuboPrice, getPriceCategory } from '../utils/priceFormatter';
...
const PriceDisplay = ({
  ...
  const depositInfo = deposit ? formatDepositInfo(rent, deposit) : null;
  ...
  return (
    <div className="space-y-2">
      ...
      <div className="space-y-1">
        ...
        {depositInfo && (
          <div className={`${size === 'small' ? 'text-xs' : 'text-sm'} text-gray-600`}>
            {depositInfo} ({formatPriceWithCommas(deposit)})
          </div>
        )}
